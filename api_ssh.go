...
func (r ApiCreateSSHKeyRequest) DtoCreateSSHRequest(dtoCreateSSHRequest DtoCreateSSHRequest) ApiCreateSSHKeyRequest {
	r.dtoCreateSSHRequest = &dtoCreateSSHRequest
	return r
}
...
func (a *SshAPIService) CreateSSHKeyExecute(r ApiCreateSSHKeyRequest) (*DtoSshResponse, *http.Response, error) {
	...
	if r.dtoCreateSSHRequest == nil {
		return localVarReturnValue, nil, reportError("dtoCreateSSHRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.dtoCreateSSHRequest
	if r.ctx != nil {
...
// Execute executes the request
func (a *SshAPIService) DeleteSSHKeyExecute(r ApiDeleteSSHKeyRequest) (*http.Response, error) {
	var (
...
func (r ApiGetSSHKeyRequest) Execute() (*GetSSHKey200Response, *http.Response, error) {
...
func (a *SshAPIService) GetSSHKeyExecute(r ApiGetSSHKeyRequest) (*GetSSHKey200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *GetSSHKey200Response
	)
