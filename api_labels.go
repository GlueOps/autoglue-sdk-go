...
// Label payload
func (r ApiCreateLabelRequest) DtoCreateLabelRequest(dtoCreateLabelRequest DtoCreateLabelRequest) ApiCreateLabelRequest {
	r.dtoCreateLabelRequest = &dtoCreateLabelRequest
	return r
}
...
func (a *LabelsAPIService) CreateLabelExecute(r ApiCreateLabelRequest) (*DtoLabelResponse, *http.Response, error) {
	...
	if r.dtoCreateLabelRequest == nil {
		return localVarReturnValue, nil, reportError("dtoCreateLabelRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.dtoCreateLabelRequest
	if r.ctx != nil {
...
// Fields to update
func (r ApiUpdateLabelRequest) DtoUpdateLabelRequest(dtoUpdateLabelRequest DtoUpdateLabelRequest) ApiUpdateLabelRequest {
	r.dtoUpdateLabelRequest = &dtoUpdateLabelRequest
	return r
}
...
func (a *LabelsAPIService) UpdateLabelExecute(r ApiUpdateLabelRequest) (*DtoLabelResponse, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.dtoUpdateLabelRequest == nil {
		return localVarReturnValue, nil, reportError("dtoUpdateLabelRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.dtoUpdateLabelRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["OrgKeyAuth"]; ok {
