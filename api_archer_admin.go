...
func (r ApiAdminCancelArcherJobRequest) Body(body map[string]interface{}) ApiAdminCancelArcherJobRequest {
	r.body = &body
	return r
}
...
// Job parameters
func (r ApiAdminEnqueueArcherJobRequest) DtoEnqueueRequest(dtoEnqueueRequest DtoEnqueueRequest) ApiAdminEnqueueArcherJobRequest {
	r.dtoEnqueueRequest = &dtoEnqueueRequest
	return r
}
...
func (a *ArcherAdminAPIService) AdminEnqueueArcherJobExecute(r ApiAdminEnqueueArcherJobRequest) (*DtoJob, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.dtoEnqueueRequest == nil {
		return localVarReturnValue, nil, reportError("dtoEnqueueRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.dtoEnqueueRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["BearerAuth"]; ok {
...
func (r ApiAdminRetryArcherJobRequest) Body(body map[string]interface{}) ApiAdminRetryArcherJobRequest {
	r.body = &body
	return r
}
