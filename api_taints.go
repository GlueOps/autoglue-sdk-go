...
// Taint payload
func (r ApiCreateTaintRequest) DtoCreateTaintRequest(dtoCreateTaintRequest DtoCreateTaintRequest) ApiCreateTaintRequest {
	r.dtoCreateTaintRequest = &dtoCreateTaintRequest
	return r
}
...
func (a *TaintsAPIService) CreateTaintExecute(r ApiCreateTaintRequest) (*DtoTaintResponse, *http.Response, error) {
	...
	if r.dtoCreateTaintRequest == nil {
		return localVarReturnValue, nil, reportError("dtoCreateTaintRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.dtoCreateTaintRequest
	if r.ctx != nil {
...
func (r ApiDeleteTaintRequest) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *TaintsAPIService) DeleteTaintExecute(r ApiDeleteTaintRequest) (*http.Response, error) {
	var (
...
// Fields to update
func (r ApiUpdateTaintRequest) DtoUpdateTaintRequest(dtoUpdateTaintRequest DtoUpdateTaintRequest) ApiUpdateTaintRequest {
	r.dtoUpdateTaintRequest = &dtoUpdateTaintRequest
	return r
}
...
func (a *TaintsAPIService) UpdateTaintExecute(r ApiUpdateTaintRequest) (*DtoTaintResponse, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.dtoUpdateTaintRequest == nil {
		return localVarReturnValue, nil, reportError("dtoUpdateTaintRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.dtoUpdateTaintRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["OrgKeyAuth"]; ok {
