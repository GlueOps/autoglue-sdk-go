...
// Key options
func (r ApiCreateUserAPIKeyRequest) HandlersCreateUserKeyRequest(handlersCreateUserKeyRequest HandlersCreateUserKeyRequest) ApiCreateUserAPIKeyRequest {
	r.handlersCreateUserKeyRequest = &handlersCreateUserKeyRequest
	return r
}
...
func (a *MeAPIKeysAPIService) CreateUserAPIKeyExecute(r ApiCreateUserAPIKeyRequest) (*HandlersUserAPIKeyOut, *http.Response, error) {
	...
	if r.handlersCreateUserKeyRequest == nil {
		return localVarReturnValue, nil, reportError("handlersCreateUserKeyRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.handlersCreateUserKeyRequest
	if r.ctx != nil {
