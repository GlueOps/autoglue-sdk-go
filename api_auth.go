...
// Refresh token
func (r ApiLogoutRequest) DtoLogoutRequest(dtoLogoutRequest DtoLogoutRequest) ApiLogoutRequest {
	r.dtoLogoutRequest = &dtoLogoutRequest
	return r
}
...
func (a *AuthAPIService) LogoutExecute(r ApiLogoutRequest) (*http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.dtoLogoutRequest == nil {
		return nil, reportError("dtoLogoutRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.dtoLogoutRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return nil, err
	}
...
// Refresh token
func (r ApiRefreshRequest) DtoRefreshRequest(dtoRefreshRequest DtoRefreshRequest) ApiRefreshRequest {
	r.dtoRefreshRequest = &dtoRefreshRequest
	return r
}
...
func (a *AuthAPIService) RefreshExecute(r ApiRefreshRequest) (*DtoTokenPair, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.dtoRefreshRequest == nil {
		return localVarReturnValue, nil, reportError("dtoRefreshRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.dtoRefreshRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
