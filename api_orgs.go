...
// User &amp; role
func (r ApiAddOrUpdateMemberRequest) HandlersMemberUpsertReq(handlersMemberUpsertReq HandlersMemberUpsertReq) ApiAddOrUpdateMemberRequest {
	r.handlersMemberUpsertReq = &handlersMemberUpsertReq
	return r
}
...
func (a *OrgsAPIService) AddOrUpdateMemberExecute(r ApiAddOrUpdateMemberRequest) (*HandlersMemberOut, *http.Response, error) {
	...
	if r.handlersMemberUpsertReq == nil {
		return localVarReturnValue, nil, reportError("handlersMemberUpsertReq is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.handlersMemberUpsertReq
	if r.ctx != nil {
...
// Org payload
func (r ApiCreateOrgRequest) HandlersOrgCreateReq(handlersOrgCreateReq HandlersOrgCreateReq) ApiCreateOrgRequest {
	r.handlersOrgCreateReq = &handlersOrgCreateReq
	return r
}
...
func (a *OrgsAPIService) CreateOrgExecute(r ApiCreateOrgRequest) (*ModelsOrganization, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.handlersOrgCreateReq == nil {
		return localVarReturnValue, nil, reportError("handlersOrgCreateReq is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.handlersOrgCreateReq
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["BearerAuth"]; ok {
...
func (r ApiCreateOrgKeyRequest) HandlersOrgKeyCreateReq(handlersOrgKeyCreateReq HandlersOrgKeyCreateReq) ApiCreateOrgKeyRequest {
	r.handlersOrgKeyCreateReq = &handlersOrgKeyCreateReq
	return r
}
...
func (a *OrgsAPIService) CreateOrgKeyExecute(r ApiCreateOrgKeyRequest) (*HandlersOrgKeyCreateResp, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.handlersOrgKeyCreateReq == nil {
		return localVarReturnValue, nil, reportError("handlersOrgKeyCreateReq is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.handlersOrgKeyCreateReq
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["BearerAuth"]; ok {
...
// Update payload
func (r ApiUpdateOrgRequest) HandlersOrgUpdateReq(handlersOrgUpdateReq HandlersOrgUpdateReq) ApiUpdateOrgRequest {
	r.handlersOrgUpdateReq = &handlersOrgUpdateReq
	return r
}
...
func (a *OrgsAPIService) UpdateOrgExecute(r ApiUpdateOrgRequest) (*ModelsOrganization, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.handlersOrgUpdateReq == nil {
		return localVarReturnValue, nil, reportError("handlersOrgUpdateReq is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.handlersOrgUpdateReq
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["BearerAuth"]; ok {
